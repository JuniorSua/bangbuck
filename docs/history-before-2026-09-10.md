# Historical project notes — before the September 10 reassessment

These notes preserve earlier decisions and observations. Rankings, counts, and current-state claims below are historical; see the root README for the current methodology and running instructions.
